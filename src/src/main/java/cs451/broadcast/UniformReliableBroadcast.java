...
public class UniformReliableBroadcast implements Observer {
    // Threads used: Main, Signal Handler, UDP Receiver, UDP Sender Pool 4, SendPool 1
    ...
    public UniformReliableBroadcast(byte myId, int port, Observer observer, HashMap<Byte, Host> hostMap) {
