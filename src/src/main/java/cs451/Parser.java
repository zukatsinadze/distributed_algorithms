...
public class Parser {
  ...
  public Parser(String[] args) { this.args = args; }
  ...
  public void parse() {
    ...
    if (!hostsParser.populate(args[Constants.HOSTS_KEY],
                              args[Constants.HOSTS_VALUE])) {
      help();
    }
    ...
    if (!outputParser.populate(args[Constants.OUTPUT_KEY],
                               args[Constants.OUTPUT_VALUE])) {
      help();
    }
  ...
  public int myId() { return idParser.getId(); }

  public List<Host> hosts() { return hostsParser.getHosts(); }

  public String output() { return outputParser.getPath(); }
